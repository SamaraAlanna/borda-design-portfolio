<style>
  ...
  .proj-img img {
    ...
    transition: transform 0.45s cubic-bezier(0.4,0,0.2,1); display: block;
  }
  .proj-placeholder {
  ...
  .proj-content { padding: 1.5rem 1.75rem 1.75rem; display: flex; flex-direction: column; gap: 0.75rem; flex: 1; }
  ...
  .proj-num { font-size: 0.68rem; color: var(--text-dim); letter-spacing: 0.06em; }
  .project-card h3 { font-size: 1rem; font-weight: 700; color: var(--text); letter-spacing: -0.02em; line-height: 1.3; }
  .project-card p { font-size: 0.8rem; color: var(--text-muted); font-weight: 400; line-height: 1.65; flex: 1; }
  .proj-footer { display: flex; align-items: center; justify-content: space-between; padding-top: 1rem; border-top: 0.5px solid var(--border); }
  .proj-tools { display: flex; gap: 0.35rem; flex-wrap: wrap; }
  .tool-tag {
    font-size: 0.65rem; color: var(--text-dim);
    border: 0.5px solid var(--border); border-radius: 99px;
    padding: 0.15rem 0.55rem; transition: border-color 0.2s, color 0.2s;
  }
